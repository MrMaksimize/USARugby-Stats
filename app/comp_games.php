...
echo "<td align='center'><a href='/competition/game.php?id={$row['id']}'>{$row['home_score']} - {$row['away_score']}</a></td>\n";
...
echo "<input type='hidden' name='grefresh' id='grefresh' value='/competition/comp_games.php?id=$comp_id' />\n";
