...
<input type='hidden' name='subrefresh' id='subrefresh' value='<? echo "http://usarugby.us/competition/game_sub_events.php?game_id=$game_id"; ?>'>
<input type='hidden' name='sub_game_id' id='sub_game_id' value=<? echo "$game_id"; ?>>
