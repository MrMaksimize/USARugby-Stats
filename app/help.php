...
<h2>Overview</h2>
<p>The National Championship Series web application is designed to facilitate the management of championship event rosters, scores, and game information.
  It is designed to work from any phone, computer, or tablet that can access the internet.</p>
...
<p>For both rosters, simply select the players for the rosters using the dropdowns and click Update Roster below the roster.
For Game Rosters, please provide accurate jersey numbers for all players.</p>
